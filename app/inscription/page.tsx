...
export default function PageInscription() {
  ...
  return (
    ...
    >
      <div className="absolute top-12 text-center px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">Rejoignez l'Hôtel Prestige</h2>
        <p className="text-white/70 text-sm md:text-base">Créez votre compte en quelques secondes</p>
      </div>
  ...
  <circle cx="38" cy="18" r="1.5" fill="#0a0a14"/>
          ...
          <p className="text-muted-foreground text-sm mt-1">Rejoignez Hôtel Prestige</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input id="confirm" name="confirm" type="password" placeholder="••••••••" onChange={handleChange} required />
          </div>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          Déjà un compte ?{" "}
          <Link href="/connexion" className="text-foreground font-medium hover:underline">
            Se connecter
          </Link>
        </p>
      </div>
